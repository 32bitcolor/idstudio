  ...
  return (
    <>
      ...
      <P>
        ...
        of the workspace, with one of three roles:
      </P>
      <UL>
        <LI>
          <strong>Admin</strong> — manages members, groups, access, and workspace settings, in
          addition to doing the regular work.
        </LI>
        <LI>
          <strong>Manager</strong> — an oversight role that sees everything across the workspace like
          an admin, but without the member/group/settings controls.
        </LI>
        <LI>
      ...
      <UL>
        <LI>
          The <strong>left sidebar</strong> lists your modules — My Work, Intake, Boards, Projects,
          Sprints, Storyboards, and Whiteboards. Collapse it with the toggle in the header when you
          want more room.
        </LI>
        <LI>
        ...
        <LI>
          The header&rsquo;s <UI>Search</UI> box (or <UI>⌘K</UI>) jumps to any board, project,
          storyboard, or card, and <UI>+ New</UI> spins up work from anywhere.
        </LI>
      </UL>
